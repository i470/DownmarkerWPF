...
// original https://github.com/JakeGinnivan/UITextBlock/blob/master/src/UITextBlockControl/UITextBlock.cs 
// required to upgrade obsolete methdos
        ...
        public class UITextBlock : TextBlock
        {
            ...
            private static FormattedText BuildFormattedTextFrom(TextBlock textBlock, double? fontSize = null)
            {
                ...
                var formattedText = new FormattedText(
                    ...
                    textBlock.Foreground, _pixelsPerDip);
